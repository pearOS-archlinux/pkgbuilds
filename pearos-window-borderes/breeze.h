...
namespace Breeze
{
    ...
    namespace Metrics
    {
        ...
        //* corner radius of the whole window, in logical pixels
        static constexpr qreal Frame_FrameRadiusPx = 16;

        //* pearOS titlebar height, in logical pixels
        static constexpr qreal TitleBar_HeightPx = 30;

        //* pearOS button layout, in logical pixels
        static constexpr int MacOSButton_Size = 14;
        static constexpr int MacOSButton_Spacing = 9;
        static constexpr int MacOSButton_GroupRightPadding = 8;

        //* titlebar padding around the button group, in logical pixels
        static constexpr int MacOSTitleBar_Padding = 8;
