...
namespace Breeze
{
    class Decoration : public KDecoration3::Decoration
    {
        ...
        //* horizontal margin between the button group and the window edge
        qreal buttonGroupSideMargin() const;

        //* horizontal gap between the button group and the caption
        qreal captionSideMargin() const;

        //* outline drawn by the compositor around the whole window
