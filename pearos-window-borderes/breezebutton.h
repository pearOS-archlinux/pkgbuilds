...
namespace Breeze
{
    ...
    class Button : public KDecoration3::DecorationButton
    {
        ...
        //* make the window full screen, returns false when the request could not be sent
        bool fullScreenWindow() const;

        //* show the tiling menu below the maximize button
        void showSnapMenu();

        //* hover timer, drives the tiling menu
