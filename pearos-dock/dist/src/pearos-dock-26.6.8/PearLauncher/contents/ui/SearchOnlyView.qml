...
Item {
	...
	ColumnLayout {
		...
		SearchBar {
			...
			Layout.rightMargin: main.innerPadding
			showMenuButton: false
			Keys.priority: Keys.AfterItem
			Keys.forwardTo: searchList
			customIconSource: Qt.resolvedUrl('icons/feather/search.svg')
			customPlaceholderText: "Spotlight Search"
			property QtObject root: main.root
			property bool searching: main.searching
		}
		...
		SearchList {
			id: searchList
			state: searching ? "visible" : "hidden"
			visible: searching && opacity > 0
