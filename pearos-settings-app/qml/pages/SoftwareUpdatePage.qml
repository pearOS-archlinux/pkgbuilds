...
PageBase {
        ...
        Column {
            ...
            Item {
                ...
                Row {
                    ...
                    Rectangle {
                        height: 30; width: upNightLabel.implicitWidth + 20; radius: 6
                        color: Qt.rgba(0,0,0,0.08)
                        Text { id: upNightLabel; anchors.centerIn: parent; text: "Update Tonight"; font.pixelSize: 12; color: Theme.textPrimary }
                        MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor
                            onClicked: Updates.applyUpdates() }
                    }
                    Rectangle {
                        height: 30; width: upNowLabel.implicitWidth + 20; radius: 6; color: Theme.accent
    ...
    SettingsCard {
        Item {
            ...
            Text { anchors.left: parent.left; anchors.verticalCenter: parent.verticalCenter; text: "Installed"; font.pixelSize: 13; font.weight: Font.Medium; color: Theme.textPrimary }
            Text {
                anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter
                text: (SysInfo.osName || "pearOS") + " " + (SysInfo.osVersion || "")
    ...
    SettingsCard {
        Column {
            ...
            Item {
                width: parent.width; height: 44
                Text { anchors.left: parent.left; anchors.verticalCenter: parent.verticalCenter; text: "Automatic Updates"; font.pixelSize: 13; font.weight: Font.Medium; color: Theme.textPrimary }
                LiquidToggle {
                    id: autoUpdToggle
                    anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter
                    checked: true
            ...
            Item {
                width: parent.width; height: 44
                Text { anchors.left: parent.left; anchors.verticalCenter: parent.verticalCenter; text: "Beta Updates"; font.pixelSize: 13; font.weight: Font.Medium; color: Theme.textPrimary }
                LiquidToggle {
                    id: betaToggle
                    anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter
                    checked: false
