    ...
    SettingsCard {
        Item {
            ...
            Column {
                ...
                Text { text: "Key Repeat"; font.pixelSize: 13; font.weight: Font.Medium; color: Theme.textPrimary }
                Text { text: "When enabled, holding down a key repeats that key"; font.pixelSize: 12; color: Theme.textSecondary }
            }
            LiquidToggle {
                anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter
                checked: Keyboard.repeatEnabled
                onToggled: function(v) { Keyboard.setRepeatEnabled(v) }
            }
        }
    }
    Spacer {}
