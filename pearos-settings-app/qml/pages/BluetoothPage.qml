...
PageBase {
    ...
    SettingsCard {
        RowLayout {
            ...
            Image {
                source: "file:///usr/share/extras/system-settings/assets/cs-bluetooth.svg"
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            font.pixelSize: 12; color: Theme.accent; anchors.verticalCenter: parent.verticalCenter
    ...
    SettingsCard {
        Column {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        Text {
                            text: "Pair"; font.pixelSize: 12; color: Theme.accent; anchors.verticalCenter: parent.verticalCenter
            ...
            Text {
                text: "Scan for Nearby Devices"; color: Theme.accent; font.pixelSize: 13
