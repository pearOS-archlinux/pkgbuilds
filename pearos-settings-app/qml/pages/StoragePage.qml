    ...
    SettingsCard {
        Item {
            ...
            Column {
                ...
                Text { text: "Empty Trash Automatically"; font.pixelSize: 13; font.weight: Font.Medium; color: Theme.textPrimary }
                Text { text: "Delete items that have been in the Trash for more than 30 days"; font.pixelSize: 11; color: Theme.textSecondary }
            }
            Rectangle {
                anchors.right: parent.right; anchors.verticalCenter: parent.verticalCenter
                height: 28; width: emptyLbl.implicitWidth + 16; radius: 6
                color: Qt.rgba(0,0,0,0.08)
                Text { id: emptyLbl; anchors.centerIn: parent; text: "Turn On…"; font.pixelSize: 12; color: Theme.textPrimary }
