...
Q_SIGNALS:
    ...
    void basicMenuAction(const QString &actionId);
    void basicMenuShown(const QString &menuId);
    void basicMenuHidden();

public Q_SLOTS:
    void trigger(QQuickItem *ctx, int idx);
    void showBasicMenu(const QString &menuId, QQuickItem *ctx, const QVariantMap &state = {});
...
private:
    ...
    QList<QPair<QString, QString>> loadRecentFolders() const;
